...
## PriceRecords 資料庫插入錯誤修復 (CRITICAL)
- [x] 診斷插入錯誤的根本原因 - 缺少詳細日誌
- [x] 檢查 schema 定義 - schema 正確
- [x] 檢查插入邏輯 - 數據庫連接正常
- [x] 添加詳細日誌 - 現在可以清楚看到保存進度
- [x] 驗證插入成功 - 27/27 價格記錄成功保存

## 航線改動 (TPE → SEA)
- [x] 更新監控 URL 從 SEA→TPE 改成 TPE→SEA
- [x] 測試新的監控配置 - 成功抽取 31 個 TPE→SEA 票價
- [x] 更新前端標題從 SEA→TPE 改成 TPE→SEA
